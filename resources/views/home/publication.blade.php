        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav mx-auto">
                    ...
                    <a class="nav-link  active" aria-current="page" href="publications">Publications</a>
    ...
    <section id="publication">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2>Publications</h2>
                    <div class="row-publications mb-lg-5"></div>
                </div>
                <div class="col-12 text-center">
                    <h2>Journal Rescollacomm</h2>
                    <div class="row-rescolacomm"></div>
                    <div class="row justify-content-center">
                        @foreach($publications as $publication)
                        <div class="col-md-3 text-center mb-4">
                            <div class="card-services">
                                <div class="circle-icon position-relative mx-auto">
                                    <img src="/image/{{$publication->image}}" width="150px" alt=""
                                        class="position-absolute to-50 start-50 translate-middle image-services">
                                </div>
                                <h3 class="mt-4">{{$publication->title}}</h3>
                                <p class="publish-text">{{$publication->description}}</p>
                            </div>
                            <a href="{{ $publication->link }}" target="_blank" class="publish-button">Visit Now</a>
                        </div>
                        @endforeach
                    </div>
                </div>
